...
const events = [
  {
    ...
    description:
      "Exploring the future of decentralized finance and blockchain innovation",
    date: "March 15, 2025",
    image:
  ...
  },
  {
    ...
    description:
      "Building the future of decentralized autonomous organizations",
    date: "April 20, 2025",
    image:
  ...
  },
  {
    ...
    date: "May 8, 2025",
    image:
      "https://images.unsplash.com/photo-1620321023374-d1a68fbc720d?w=400&h=300&fit=crop&crop=center",
  },
];
    ...
    <section className="relative bg-gradient-to-b from-daoBg via-daoSurface/10 to-daoBg min-h-screen py-32 px-8 md:px-16 lg:px-24 overflow-x-auto">
      ...
      <div className="max-w-8xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Follow our journey through the evolution of blockchain technology
