...
const features = [
  {
    ...
    background: (
      <div className="absolute -right-10 sm:-right-20 -top-10 sm:-top-20 opacity-60 w-20 h-20 sm:w-40 sm:h-40 bg-gradient-to-br from-accentCyan/20 to-accentMagenta/20 rounded-full blur-xl" />
    ),
  ...
  },
  {
    ...
    href: "/hackathons",
    background: (
      <div className="absolute -right-10 sm:-right-20 -top-10 sm:-top-20 opacity-60 w-20 h-20 sm:w-40 sm:h-40 bg-gradient-to-br from-accentMagenta/20 to-accentCyan/20 rounded-full blur-xl" />
    ),
  ...
  },
  {
    ...
    href: "/internships",
    background: (
      <div className="absolute -right-10 sm:-right-20 -top-10 sm:-top-20 opacity-60 w-20 h-20 sm:w-40 sm:h-40 bg-gradient-to-br from-accentCyan/20 to-accentPurple/20 rounded-full blur-xl" />
    ),
  ...
  },
  {
    ...
    href: "/networking",
    background: (
      <div className="absolute -right-10 sm:-right-20 -top-10 sm:-top-20 opacity-60 w-20 h-20 sm:w-40 sm:h-40 bg-gradient-to-br from-accentPurple/20 to-accentMagenta/20 rounded-full blur-xl" />
    ),
  ...
  },
  {
    ...
    href: "/mentorship",
    background: (
      <div className="absolute -right-10 sm:-right-20 -top-10 sm:-top-20 opacity-60 w-20 h-20 sm:w-40 sm:h-40 bg-gradient-to-br from-accentMagenta/20 to-accentPurple/20 rounded-full blur-xl" />
    ),
...
function BentoDemo() {
  return (
    <BentoGrid className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-4 sm:gap-6">
...
export default function StudentBenefitsPage() {
  return (
    <div className="min-h-screen bg-daoBg py-12 sm:py-16 px-4 sm:px-6 md:px-8 mt-14 sm:mt-16">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="font-orbitron text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-textPrimary mb-3 sm:mb-4">
            Student <span className="text-primary">Benefits</span>
          </h1>
